...
Class Query{
  ...
  function addtruckpackinglistinfo($commondity, $size, $pcsperbox, $kgperbox, $mc, $invoice_no){
    ...
    $addtotalcostingstmt = $pdo->prepare("INSERT INTO trucktotalcosting(item_id, size, total_kg, invoice_no, link_id) VALUES('$commondity', '$size', '$kgperbox', '$invoice_no', '$lastid')");
    $addtotalcostingstmt->execute();
  }
