          ...
          <div class="modal-body">
            ...
            <div class="row">
              <div class="col">
                ...
                <input type="number" name="quantity" <?php if(!empty($quantity_error)){ echo "class=\"form-control is-invalid\""; }else{ echo "class=\"form-control inpv2\""; } ?>>
              ...
              <div class="col">
                ...
                <input type="text" name="rate" <?php if(!empty($rate_error)){ echo "class=\"form-control is-invalid\""; }else{ echo "class=\"form-control inpv2\""; } ?>>
