              ...
              foreach ($packingdatas  as $packingdata) {
                ...
                <td>
                  <div class="d-flex">
                    ...
                    <div class="col-2">
                      <button type="button" data-bs-toggle="modal" data-bs-target="#actualpackingedit<?= $packingdata['id']; ?>" class="btn btn-warning text-light btn-sm">
