...
<body>
          ...
          <table class="mt-3 table table-bordered table-striped rounded">
            ...
            ?>
              ...
              <tr>
                ...
                <td>
                  <button type="button" class="btn btn-warning text-light btn-sm" data-bs-toggle="modal" data-bs-target="#updatemodal<?php echo $itemdata['item_id']; ?>">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form action="item.php" method="post" autocomplete="off">
          <div class="modal-body">
            <label>Item Name</label>
            <input type="text" name="item_name" id="item_name" class="form-control" placeholder="Item Name" oninput="validateInput('item', 'item_name', this.value, 'name_error')" required>
  ...
  <script>
    function validateInput(table, column, value, errorId) {
      ...
      fetch(`item.php?action=check_duplicate&table=${table}&column=${column}&value=${encodeURIComponent(value)}`)
