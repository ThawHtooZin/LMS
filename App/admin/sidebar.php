  ...
  <div class="panel-group" id="accordionsidebar">
    ...
    <ul class="nav nav-pills flex-column mt-2">
      ...
      <?php
        ...
        <?php if (str_contains($permissions, 'manage_accounts') || str_contains($permissions, 'manage_role')) { ?>
          <li class="p-1" style="font-weight:bold;">
            <!-- Parent menu stays active/highlighted when any child is open -->
            ...
            <div class="collapse <?= $is_system_active ? 'show' : ''; ?>" id="system-collapse" data-bs-parent="#accordionsidebar">
              <ul class="btn-toggle-nav list-unstyled fw-normal ms-2">
                ...
                <?php if (str_contains($permissions, 'manage_accounts')) { ?>
                  <li class="nav-item">
                    <!-- Keeps hover class 'h', adds 'active' class to current child page -->
      ...
      <?php
        ...
        $account_pages = [
          'sales.php', 'purchase.php', 'cashbook.php', 'acpayable.php', 
          'accountpayable.php', 'accountreceivable.php', 'transaction.php', 
          'general_ledger.php', 'ledger_record.php'
        ];
        ...
        ?>
          <li class="p-1" style="font-weight:bold;">
            <!-- BOTH: Main menu gets 'active' when any child page is open -->
            ...
            <div class="collapse <?= $is_account_active ? 'show' : ''; ?>" id="account-collapse" data-bs-parent="#accordionsidebar">
              <ul class="btn-toggle-nav list-unstyled fw-normal ms-2">
                ...
                <?php if (str_contains($permissions, 'manage_sale')) { ?>
                  <li class="nav-item">
                    <!-- BOTH: Sub-item gets 'active' only if matched -->
      ...
      <?php
        ...
        $config_pages = [
          'contacts.php', 'coa.php', 'products.php', 
          'product_types.php', 'currency.php', 'unit.php'
        ];
        ...
        ?>
          <li class="p-1" style="font-weight:bold;">
            <!-- Parent menu gets 'active' when any child page matches -->
            ...
            <!-- Collapse stays open when an inner page is active -->
        ...
        <?php
          ...
          ?>
            <li class="p-1" style="font-weight:bold;">
              <!-- Parent gets 'active' class when child is matched -->
              ...
              <!-- Dropdown stays open when child page is active -->
              <div class="collapse <?= $is_production_active ? 'show' : ''; ?>" id="production-collapse" data-bs-parent="#accordionsidebar">
                <ul class="btn-toggle-nav list-unstyled fw-normal ms-2">
                  <?php if (str_contains($permissions, 'manage_coldstorecharges')) { ?>
                    <li class="nav-item">
                      <!-- Child gets 'active' class when matched + removed CDN icon -->
      ...
      <?php
        ...
        ?>
          <li class="p-1" style="font-weight:bold;">
            <!-- Parent menu receives 'active' class when any child page matches -->
            ...
            <!-- Dropdown stays open when an inner page is active -->
      ...
      <?php
          ...
          $stock_pages = [
            'form_7.php', 'form_10.php', 'hhkmcstock.php', 
            'gfcmcstock.php', 'tclmcstock.php', 'stockreport.php'
          ];

          $logistic_pages = [
            'packing_stock.php', 'truck_packing_stock.php', 'packingmaterial.php'
          ];

          $report_pages = [
            'salereport.php', 'purchase_report.php', 'payablereport.php', 
            'mainstockreport.php', 'generalledgerreport.php', 'packing_material_report.php'
          ];
