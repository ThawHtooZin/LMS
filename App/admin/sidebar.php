...
<div class=" flex-column flex-shrink-0 p-1 text-white" style=" background-color:#011d36; !important; height:100%;">
  ...
  <div class="d-flex">
    ...
    <div style="width:85%; padding-right:28px; text-align:center;">
      <span style="font-size: 27px; line-height: auto !important; color: lightblue; font-style: italic; font-weight:bold; text-shadow: 4px 4px 4px #1F51FF;" id="navtitle">Link Mark System</span>
    </div>
  </div>
    <ul class="nav nav-pills flex-column mt-2">
      ...
      <li  class=" p-1" style=" font-weight:bold; border-bottom: 1px solid rgb(255,255,255,0.2); " >
        ...
        <div class="collapse" id="account-collapse" data-bs-parent="#accordion">
          <ul class="btn-toggle-nav list-unstyled fw-normal">
            <?php
            if(str_contains($permissions, 'manage_sale')){
              ?>
            <li class="nav-item" style="cursor: not-allowed !important;">
              <a href="sales.php" class="nav-link h text-light show disabled"   style="font-size:14px !important; ">
                <svg class="bi" style="padding-right: 15px !important;" width="16" height="16"><i class="bi bi-tags"></i></svg>
                - Sales
              </a>
            </li>
      ...
      <li class=" p-1" style=" font-weight:bold; border-bottom: 1px solid rgb(255,255,255,0.2); " >
        ...
        <div class="collapse" id="config-collapse" data-bs-parent="#accordion">
          <ul class="btn-toggle-nav list-unstyled fw-normal ms-2">
            <?php
      ...
      <li class=" p-1" style=" font-weight:bold; border-bottom: 1px solid rgb(255,255,255,0.2); " >
        ...
        <div class="collapse" id="production-collapse" data-bs-parent="#accordion">
          <ul class="btn-toggle-nav list-unstyled fw-normal ms-2">
            ...
            ?>
            <!-- <li class="nav-item">
              <a href="container.php" class="nav-link h text-light"  style="font-size:14px !important; ">
                <svg class="bi" style="padding-right: 15px !important;" width="16" height="16"><i class="bi bi-box"></i></svg>
                - Container
              </a>
            </li> -->
      ...
      <li class=" p-1" style=" font-weight:bold; border-bottom: 1px solid rgb(255,255,255,0.2); " >
        <a href="#" class="nav-link text-white report" id="sidebarlink" data-bs-toggle="collapse" data-bs-target="#logestic-collapse" aria-expanded="false">
          <svg fill="#fff" version="1.1" width="20" height="20" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512" xml:space="preserve"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <g> <g> <path d="M371.421,245.014v-37.372h-60.475v-60.475H250.47h-30.578h-60.475v60.475v30.578v29.898h-10.195v-93.827h-48.009v-18.15 h23.245v-30.578h-23.245v-23.245H70.636v23.245H47.391v30.578h23.245v18.15H22.629v93.827H0l44.954,141.564h414.755L512,245.014 H371.421z M310.944,238.22h29.899v6.795h-18.388l-7.337,23.103h-4.174V238.22z M250.469,177.745h29.898v29.898h-29.898V177.745z M250.469,238.22h29.898v29.898h-29.898V238.22z M189.994,177.745h29.898v29.898h-29.898V177.745z M189.994,238.22h29.898v29.898 h-29.898V238.22z M53.207,204.869h65.437v63.25H53.207V204.869z M437.337,379.104H67.326l-25.533-80.409h107.428h10.195h60.475 h30.578h29.898h30.578h26.546l7.337-23.103h26.592h98.787L437.337,379.104z"></path> </g> </g> <g> <g> <rect x="358.512" y="291.67" width="31.597" height="30.578"></rect> </g> </g> <g> <g> <rect x="408.19" y="291.67" width="31.597" height="30.578"></rect> </g> </g> </g></svg>
          <span id="navname">Logestic</span> <i class="text-light arrow arrdown"></i>
        </a>
        <div class="collapse" id="logestic-collapse" data-bs-parent="#accordion">
          <ul class="btn-toggle-nav list-unstyled fw-normal ms-2">
            <?php
