...
$permissions = $permission['permission'];
 ?>
<div class=" flex-column flex-shrink-0 p-1 text-white" style=" background-color:rgb(52, 61, 85); !important; height:100%;">
  <button type="button" class="btn btn-default text-light" id="menu" style="margin-left: 6.4px;">
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-list" viewBox="0 0 16 16">
      <path fill-rule="evenodd" d="M2.5 12a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5z"/>
    </svg>
  </button>
  <span style="font-size: 20px; line-height: auto !important;" id="navtitle">Link Mark System</span>
