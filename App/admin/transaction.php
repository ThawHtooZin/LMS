...
<body>
  ...
  if (isset($_POST['update'])) {
    ...
    $bank_charges = $_POST['bank_charges'];
    $query->updatetransaction_fromtransaction($date, $voucher_no, $ac_code, $description, $currency, $rate, $debit, $credit, $id,  $sr_no, $container_no, $bank_charges);
  }
    ...
    <div class="contentcol" id="content">
      ...
      <div class="card">
            ...
            <div id="adddiv" class="collapse mb-2 show" name="outsidething" data-bs-parent="#accordion">
              <form action="" method="post">
                <div class="row">
                  <div class="col">
                    <label>Date</label>
                    <input type="date" name="adddate" style="<?php if (!empty($addvoucher_noerror) && $addvoucher_noerror == 'error') {
                                                                echo 'border: 1px solid red !important;';
                                                              } ?>" class="form-control inpv2 mb-1" value="<?php if (!empty($_SESSION['adddate'])) {
                                                                                                              echo $_SESSION['adddate'];
                                                                                                            } ?>" style="padding-top: 2px; padding-bottom: 2px;">
                  </div>
                  <div class="col">
                    <label>Vr. No</label>
                    <input type="text" name="addvoucher_no" style="<?php if (!empty($adddateerror) && $adddateerror == 'error') {
                                                                      echo 'border: 1px solid red !important;';
                                                                    } ?>" class="form-control inpv2 mb-1" value="<?php if (!empty($_SESSION['addvoucher_no'])) {
                                                                                                                    echo $_SESSION['addvoucher_no'];
                                                                                                                  } ?>" style="padding-top: 2px; padding-bottom: 2px;" id="voucher_no">
                  </div>
                  <div class="col">
                    <label>A/C Code</label>
                    <div class="d-flex">
                      <input type="text" id="addac_code" style="<?php if (!empty($addac_codeerror) && $addac_codeerror == 'error') {
                                                                  echo 'border: 1px solid red !important;';
                                                                } ?>" name="addac_code" class="form-control inpv2 mb-1" value="<?php if (!empty($_SESSION['addac_code'])) {
                                                                                                                                  echo $_SESSION['addac_code'];
                                                                                                                                } ?>" style="padding-top: 2px; padding-bottom: 2px; width:90%;">
                    ...
                    <!-- <div class="d-flex">
                    <input type="text" id="addac_code" name="addac_code" class="form-control inpv2 mb-1" value="<?php if (!empty($_SESSION['addac_code'])) {
                                                                                                                  echo $_SESSION['addac_code'];
                                                                                                                } ?>" style="padding-top: 2px; padding-bottom: 2px; width:90%;">
                  ...
                  <div class="col">
                    ...
                    <div id='addac_name' style="padding-top:2px; padding-bottom:2px;">
                      <input type="text" name="addac_name" disabled class="form-control inpv2 mb-1" value="<?php if (!empty($_SESSION['ac_name'])) {
                ...
                <div class="row">
                  <div id="normal" class="col-6 d-flex" style="width: 50%;">
                    <div class="col-9">
                      ...
                      <textarea name="adddescription" rows="3" style="padding-bottom:10px; height:75px;" cols="80" class="form-control inpv2 mb-2"><?php if (!empty($_SESSION['description'])) {
                  ...
                  <div class="col-3">
                    ...
                    <div class="d-flex gap-2 mt-3">
                      <input type="text" name="adddebit" style="<?php if (!empty($adddebiterror) && $adddebiterror == 'error') {
                                                                  echo 'border: 1px solid red !important;';
                                                                } ?>" id="adddebitinp" class="form-control inpv2" placeholder="Debit" style="padding-top: 2px; padding-bottom: 2px; width: 45%; display:inline; margin-top:15px;">
                      <input type="text" name="addcredit" style="<?php if (!empty($addcrediterror) && $addcrediterror == 'error') {
                                                                    echo 'border: 1px solid red !important;';
                                                                  } ?>" id="addcreditinp" class="form-control inpv2" placeholder="Credit" style="padding-top: 2px; padding-bottom: 2px; width: 45%; display:inline; margin-top:15px; margin-left:20px;">
                    </div>
                  </div>
                  <div class="col-3">
                    <label>Rate</label>
            ...
            <table class="table table-hover table-striped">
              ...
              ?>
                <tr data-bs-toggle="collapse" data-bs-target="#updatecollapse<?php echo $data['id'];  ?>" id="collapsebtn">
                  ...
                  <td><?php echo $no; ?></td>
                  <td><?php if ($data['date'] != 0) {
                        echo date('d-m-Y', strtotime($data['date']));
                      } ?></td>
                  <td><?php if ($data['voucher_no'] != 0) {
                        echo $data['voucher_no'];
                      } ?></td>
                  <td><?php if ($data['ac_code'] != 0) {
                        echo $acname['ac_name'];
                      } ?></td>
                  <td><?php if ($data['debit'] != 0) {
                        echo $data['debit'];
                      } ?></td>
                  <td><?php if ($data['credit'] != 0) {
                        echo $data['credit'];
                      } ?></td>
                </tr>
                <?php
                    ...
                    <form action="" method="post">
                      ...
                      <div class="row">
                        <div id="normal" class="col-6 d-flex" style="width: 50%;">
                          ...
                          <div id="upreceive2<?php echo $data['id']; ?>" class="<?php if (!str_contains($updata['ac_code'], 3300)) {
                                                                                  echo "hide";
                                                                                } ?> col-2">
                          ...
                          <div id="bankcharges<?php echo $data['id']; ?>" class="<?php if (!str_contains($updata['ac_code'], 3600)) {
                                                                                    echo "hide";
                                                                                  } ?>">
                            <input type="text" class="form-control inpv2 mb-3 mt-4" style="padding-top: 2px; padding-bottom: 2px;" name="bank_charges" placeholder="Bank Charges" value="<?php if ($updata['bank_charges'] != "0") {
                                                                                                                                                                                            echo $updata['bank_charges'];
                                                                                                                                                                                          } ?>">
                          </div>
                        </div>
                        <div class="col-3">
                          ...
                          <select class="form-control inpv2" name="currency" onchange="check<?php echo $data['id']; ?>rate();" id="selectcurrecy<?php echo $data['id']; ?>" style="padding-top: 2px; padding-bottom: 2px;">
                            <option value="usd" <?php if ($updata['currency'] == 'usd') {
                                                  echo 'selected';
                                                } ?>>USD</option>
                            <option value="mmk" <?php if ($updata['currency'] == 'mmk') {
                                                  echo 'selected';
                                                } ?>>MMK</option>
                          </select>
                          <input type="text" id="debitinp<?php echo $id; ?>" name="debit" class="form-control inpv2 mt-3" value="<?php if (!empty($updata['debit'])) {
                                                                                                                                    if ($updata['currency'] != 'usd') {
                                                                                                                                      echo $updata['debit'];
                                                                                                                                    } else {
                                                                                                                                      echo $currencydata['usd_amount'];
                                                                                                                                    };
                                                                                                                                  } ?>" placeholder="Debit" style="padding-top: 2px; padding-bottom: 2px; width:45%; display:inline;">
                          <input type="text" id="creditinp<?php echo $id; ?>" name="credit" class="form-control inpv2 mt-3" placeholder="Credit" value="<?php if (!empty($updata['credit'])) {
                                                                                                                                                          if ($updata['currency'] != 'usd') {
                                                                                                                                                            echo $updata['credit'];
                                                                                                                                                          } else {
                                                                                                                                                            echo $currencydata['usd_amount'];
                                                                                                                                                          };
                                                                                                                                                        } ?>" style="padding-top: 2px; padding-bottom: 2px; width:45%; margin-left:20px; display:inline;">
                        </div>
                        <div class="col-3">
                          <label>Rate</label>
                          <input type="number" name="rate" class="form-control inpv2" id="rate<?php echo $data['id']; ?>" value="<?php if ($updata['currency'] == 'usd') {
                                                                                                                                    echo $currencydata['dollar_rate'];
                                                                                                                                  } ?>" <?php if ($updata['currency'] != 'usd') {
                                                                                                                                          echo 'disabled';
                                                                                                                                        } ?> style="padding-top: 2px; padding-bottom: 2px;">
        ...
        <tr style="font-weight:bold;">
          ...
          <td style="<?php if ($totaldebitdata['total'] != $totalcreditdata['total']) {
                        echo "color:red;";
                      } ?>"><?php echo round($totaldebitdata['total'], 2); ?></td>
          <td style="<?php if ($totaldebitdata['total'] != $totalcreditdata['total']) {
                        echo "color:red;";
                      } ?>"><?php echo round($totalcreditdata['total'], 2); ?></td>
        </tr>
        </table>
        </div>
        <!-- TABLEEEEEEEEEEEEEEEEEEEE -->
