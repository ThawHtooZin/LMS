          ...
          <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col">
                  ...
                  <input type="text" name="addac_code" class="form-control inpv2 mb-1" value="<?php if(!empty($_SESSION['addac_code'])){echo $_SESSION['addac_code']; } ?>" style="padding-top: 2px; padding-bottom: 2px;">
                </div>
                <div class="col">
                ...
                ?>
                  <div id='collapseofupdate'>
                      ...
                      <div class="row">
                          ...
                          <div class="col">
                            <label>A/C Code</label>
                            <input type="text" name="ac_code" class="form-control inpv2 mb-1" value="<?php echo $updata['ac_code']; ?>" style="padding-top: 2px; padding-bottom: 2px;">
                          </div>
                          <div class="col">
                            <label>A/C Name</label>
