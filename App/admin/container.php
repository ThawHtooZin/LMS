        ...
        <div class="card mt-3">
          ...
          <div class="card-body">
            ...
            if(isset($_POST['addcontainerbtn'])){
              ...
              $query->addcontainer($container_no, $country, $date);
            }
            ?>
            <button type="button" class="btn btn-success float-end" data-bs-toggle="modal" data-bs-target="#addcontainer">
              Add Container
            </button>
            <?php
            ...
            <table class="mt-5 table table-bordered table-striped rounded">
              ...
              <?php
              $containerdatas = $query->selectall("container");
              foreach ($containerdatas as $containerdata) {
              ?>
              <tr>
                <td><?php echo $containerdata['id']; ?></td>
                <td><?php echo $containerdata['container_no']; ?></td>
                <td><?php echo $containerdata['country']; ?></td>
                <td><?php echo $containerdata['date']; ?></td>
                  <!-- <input type="hidden" name="updateid" value="<?php echo $containerdate['id']; ?>">
