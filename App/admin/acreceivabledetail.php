...
// Handle Bulk/Waterfall Payment Reception
if ($_SERVER['REQUEST_METHOD'] == 'POST' and isset($_POST['receive_bulk'])) {
    ...
    // Assuming a method like receiveCustomerBalance exists in query.ctr.php
    $paymentResult = $query->receiveCustomerBalance($customer_id, $payment_date, $payment_account, $reference, $check_number, $description, $payment_amount);
}
...
");
$billsStmt->execute([$customer_id]);
$bills = $billsStmt->fetchAll(PDO::FETCH_ASSOC);

// Fetch Payment Allocations for these specific invoices to build the accordion histories
...
if (!empty($bill_ids)) {
  ...
  ");
    ...
    foreach ($all_payments as $pay) {
        $payments_by_bill[$pay['sale_id']][] = $pay;
    }
}
...
// Fetch Bank/Cash Accounts for the deposit dropdown AND tag which ones are official banks
$accStmt = $pdo->query("
        ...
        <div class="contentcol" id="content">
            ...
            <div class="card shadow-sm border-0 mt-3 ms-2 me-2">
                <div class="card-header bg-info text-light d-flex justify-content-between align-items-center">
                    <h5 class="mb-0"><?= htmlspecialchars($customer_name); ?> Receivable Detail Info</h5>
                    <div>
                        ...
                        <?php endif; ?>
                        <a href="acreceivable.php" class="btn btn-light btn-sm fw-bold">Back</a>
                    </div>
                </div>
                <div class="card-body">
                    <table class="table table-bordered table-striped rounded">
                        ...
                        <tbody>
                            <?php if (empty($bills)): ?>
                                <tr>
                                    <td colspan="6" class="text-center">No authorized or paid invoices found for this customer.</td>
                                </tr>
                            <?php else: ?>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header bg-success text-light">
                        <h5 class="modal-title">Receive Payment from <?= htmlspecialchars($customer_name); ?></h5>
                        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <form action="" method="post">
                        <div class="modal-body">
                            <input type="hidden" name="receive_bulk" value="1">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <label class="form-label fw-bold small">Deposit To (Bank/Cash Account)</label>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-success fw-bold px-4">Receive Payment</button>
                        </div>
                    </form>
                </div>
            </div>
