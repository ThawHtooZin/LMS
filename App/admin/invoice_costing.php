...
<body>
  ...
  if (isset($_POST['sellingpriceupdatebtn'])) {
    $sellingpriceperkg = $_POST['sellingpriceupdatekg'];
            ...
            <table class="table table-striped table-hover table-bordered actualinvoicetable">
              ...
              for ($i = 0; $i < $commonditycountdatas; $i++) {
                ...
                foreach ($invoicecostingdatas as $invoicecostingdata) {
                  ...
                  // FIXED: Pull from products table using id
              ...
              ?>
                  <tr data-bs-toggle="modal" data-bs-target="#updatemodal<?php echo $invoicecostingdata['id']; ?>">
                    ...
                    <td><?php echo htmlspecialchars($invoicecostingdata['size']); ?></td>
                    <td><?php echo $totalkgdata['totalkg']; ?></td>
                    <td><?php if ($invoicecostingdata['priceperviss'] != 0) {
                          echo $invoicecostingdata['priceperviss'];
                        }; ?></td>
                    <td><?php if (!empty($invoicecostingdata['priceperkg'])) {
                          echo round($invoicecostingdata['priceperkg'], 2);
                        } ?></td>
                    <td><?php if ($invoicecostingdata['yield'] != 0) {
                          echo $invoicecostingdata['yield'];
                        }; ?></td>
                    <td><?php if (!empty($invoicecostingdata['total_price'])) {
                          echo round($invoicecostingdata['total_price'], 2);
                        } ?></td>
                    <td><?php if (!empty($invoicecostingdata['usd'])) {
                          echo round($invoicecostingdata['usd'], 2);
                        } ?></td>
                    <td><?php if ($invoicecostingdata['packing_material'] != 0) {
                          echo $invoicecostingdata['packing_material'];
                        }; ?></td>
                    <td><?php if ($invoicecostingdata['ocean_pacific'] != 0) {
                          echo $invoicecostingdata['ocean_pacific'];
                        }; ?></td>
                    <td><?php if ($invoicecostingdata['tax'] != 0) {
                          echo $invoicecostingdata['tax'];
                        }; ?></td>
                    <td><?php if ($invoicecostingdata['agent'] != 0) {
                          echo $invoicecostingdata['agent'];
                        }; ?></td>
                    <td><?php if ($invoicecostingdata['transport'] != 0) {
                          echo $invoicecostingdata['transport'];
                        } ?></td>
                    <td><?php if (!empty($invoicecostingdata['total_usd'])) {
                          echo round($invoicecostingdata['total_usd'], 2);
                        } ?></td>
                    <td><?php if (!empty($invoicecostingdata['total_kg_price'])) {
                          echo round($invoicecostingdata['total_kg_price'], 2);
                        } ?></td>
                  </tr>
                        ...
                        <form action="" method="post">
                          ...
                          <div class="modal-body">
                            <div class="row">
                              ...
                              <div class="col">
                                <label>Yield</label>
                                <input type="text" name="yield" class="form-control inpv2 mb-2" value="<?php if ($invoicecostingdata['yield'] != '') {
                                                                                                          echo $invoicecostingdata['yield'];
                                                                                                        } else {
                                                                                                          if (!empty($_SESSION['yield'])) {
                                                                                                            echo $_SESSION['yield'];
                                                                                                          }
                                                                                                        }; ?>">
                              </div>
                            ...
                            <div class="row">
                              ...
                              <div class="col">
                                ...
                                <input type="text" name="ocean_pacific" class="form-control inpv2 mb-2" value="<?php if ($invoicecostingdata['ocean_pacific'] != '') {
                                                                                                                  echo $invoicecostingdata['ocean_pacific'];
                                                                                                                } else {
                                                                                                                  if (!empty($_SESSION['ocean_pacific'])) {
                                                                                                                    echo $_SESSION['ocean_pacific'];
                                                                                                                  }
                                                                                                                }; ?>">
                              </div>
                            </div>
                            <div class="row">
                              ...
                              <div class="col">
                                <label>Agent</label>
                                <input type="text" name="agent" class="form-control inpv2 mb-2" value="<?php if ($invoicecostingdata['agent'] != '') {
                                                                                                          echo $invoicecostingdata['agent'];
                                                                                                        } else {
                            ...
                            <div class="row">
                              <div class="col">
                                ...
                                <input type="text" name="transport" class="form-control inpv2 mb-2" value="<?php if ($invoicecostingdata['transport'] != '') {
                                                                                                              echo $invoicecostingdata['transport'];
                                                                                                            } else {
                              ...
                              <div class="col">
                                ...
                                <input type="text" name="dollar" class="form-control inpv2 mb-2" value="<?php if (!empty($_SESSION['dollar'])) {
                ...
                <tr>
                  ...
                  <td></td>
                  <td></td>
                  <td style="font-weight:bold;"><?php if (round(floatval($totalkgpricedata['totalkgprice']), 2) != 0) {
                                                  echo round(floatval($totalkgpricedata['totalkgprice']), 2);
                                                }; ?></td>
                </tr>
              <?php
              }
            ...
            <table class="table table-striped table-hover table-bordered actualinvoicetable hide">
              ...
              ?>
                  <tr data-bs-toggle="modal" data-bs-target="#updatemodal2<?php echo $invoicecostingdata['id']; ?>">
                    ...
                    <td><?php echo htmlspecialchars($invoicecostingdata['size']); ?></td>
                    <td><?php echo $totalkgdata['totalkg']; ?></td>
                    <td><?php if (round(floatval($invoicecostingdata['total_usd']), 2) != 0) {
                          echo round(floatval($invoicecostingdata['total_usd']), 2);
                        }; ?></td>
                    <td><?php if ($invoicecostingdata['sellingpriceperkg'] != 0) {
                          echo $invoicecostingdata['sellingpriceperkg'];
                        }; ?></td>
                    <td><?php if (!empty($invoicecostingdata['total_kg_price'])) {
                          echo round($invoicecostingdata['total_kg_price'], 2);
                        } ?></td>
                    <td><?php if ($invoicecostingdata['total_selling_price'] != 0) {
                          echo $invoicecostingdata['total_selling_price'];
                        }; ?></td>
                    <td><?php if (round(floatval($invoicecostingdata['profitorlossperkg']), 2) != 0) {
                          echo round(floatval($invoicecostingdata['profitorlossperkg']), 2);
                        }; ?></td>
                    <td><?php if (round(floatval($invoicecostingdata['profit_amount']), 2) != 0) {
                          echo round(floatval($invoicecostingdata['profit_amount']), 2);
                        }; ?></td>
                  </tr>
                        ...
                        <div class="modal-body">
                          <form action="" method="post">
                            ...
                            <div class="modal-body">
                              ...
                              <input type="text" name="sellingpriceupdatekg" class="form-control inpv2 mb-2 mt-2">
                            </div>
                            <div class="modal-footer">
                              <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                ...
                <tr>
                  ...
                  <td style="font-weight:bold;"><?php if (round(floatval($totalkgsellingpricedata['total_selling_price']), 2) != 0) {
                                                  echo round(floatval($totalkgsellingpricedata['total_selling_price']), 2);
                                                }; ?></td>
                  <td></td>
                  <td style="font-weight:bold;"><?php if (round(floatval($totalkgprofitdata['profit_amount']), 2) != 0) {
                                                  echo round(floatval($totalkgprofitdata['profit_amount']), 2);
                                                }; ?></td>
                </tr>
              <?php
              }
