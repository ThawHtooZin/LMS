...
function selectTestingExportProduct($productId)
{
  global $pdo;
...
function selectTestingExportAccount($code)
{
  global $pdo;
...
function selectTestingExportContact($contactId)
{
  global $pdo;
...
function selectTestingExportParty($value)
{
  $contact = selectTestingExportContact($value);
  if ($contact !== false) {
    return $contact;
  }

  $account = selectTestingExportAccount($value);
  if ($account !== false) {
    return $account;
  }
    ...
    if (isset($_GET['searchgeneralledger'])) {
      ...
      for ($i = 0; $i < $acnamecount; $i++) {
        ...
        if (!empty($acnamedontloop) && $acnamedontloop > 1) {
          ...
          $acnametoshow = selectTestingExportAccount($accode);
        } else {
          $gldatas = $query->search('general_ledger', 'ac_code', $ac_code);
          $acnametoshow = selectTestingExportAccount($ac_code);
        }
    ?>
        <tr>
          <td colspan="7"><b><u><?php echo "Account No. : " . $ac_code . " - " . $acnametoshow['name']; ?></u></b></td>
        </tr>
        <?php
        foreach ($gldatas as $gldata) : ?>
          <?php
          $ac_code = $gldata['ac_code'];
          $acname = selectTestingExportAccount($ac_code);
          ...
          if (str_contains($accode, '4000/')) {
            ...
            $acnamedata = selectTestingExportAccount($accode);
            $acname = $acnamedata['name'];
          }
          // acnamechange
      ...
      for ($i = 0; $i < $acnamecount; $i++) {
        ...
        $accode = $accodedata[$i]['ac_code'];
        $gldatas = $query->search('general_ledger', 'ac_code', $accode);
        $acname = selectTestingExportAccount($accode);
      ?>
        <tr>
          <td colspan="7"><b><u><?php echo "Account No. : " . $accode . " - " . $acname['name']; ?></u></b></td>
        </tr>
...
?>
  <table class="table table-bordered" border="1">
    ...
    ?>
      <tr>
        <td><?php if ($total_charges_data['date'] != "0000-00-00") {
        ...
        <td><?php if ($total_charges_data['total_coldstore_charges'] != "0") {
              echo $total_charges_data['total_coldstore_charges'];
            }; ?></td>
        <td><?php if ($total_charges_data['total_labour_charges'] != "0") {
              echo $total_charges_data['total_labour_charges'];
            }; ?></td>
        <td><?php if ($total_charges_data['total_processing_charges'] != "0") {
              echo $total_charges_data['total_processing_charges'];
            }; ?></td>
        <td data-bs-toggle="modal" data-bs-target="#updatetotalcharges<?php echo $total_charges_data['id']; ?>"><?php if ($total_charges_data['repacking_charges'] != "0") {
                                                                                                                  echo $total_charges_data['repacking_charges'];
                                                                                                                }; ?></td>
        <td data-bs-toggle="modal" data-bs-target="#updatetotalcharges<?php echo $total_charges_data['id']; ?>"><?php if ($total_charges_data['ice_charges'] != "0") {
                                                                                                                  echo $total_charges_data['ice_charges'];
                                                                                                                }; ?></td>
        <td data-bs-toggle="modal" data-bs-target="#updatetotalcharges<?php echo $total_charges_data['id']; ?>"><?php if ($total_charges_data['ot_charges'] != "0") {
                                                                                                                  echo $total_charges_data['ot_charges'];
                                                                                                                }; ?></td>
        <td><?php if ($total_charges_data['total_charges'] != "0") {
              echo $total_charges_data['total_charges'];
            }; ?></td>
        <td><?php if ($total_charges_data['grand_total_charges'] != "0") {
              echo $total_charges_data['grand_total_charges'];
            }; ?></td>
        <td><?php if ($total_charges_data['payment_date'] != "0000-00-00") {
              echo date('d-m-Y', strtotime($total_charges_data['payment_date']));
            }; ?></td>
        <td><?php if ($total_charges_data['payment_amount'] != "0") {
              echo $total_charges_data['payment_amount'];
            }; ?></td>
        <td><?php if ($total_charges_data['balance_amount'] != "0") {
              echo $total_charges_data['balance_amount'];
            }; ?></td>
        <td data-bs-toggle="modal" data-bs-target="#remark<?php echo $total_charges_data['id']; ?>"><?php if ($total_charges_data['remark'] != "0") {
...
?>
  <table border="1">
    ...
    ?>
      <tr>
        <td style="font-size:13px;"><?php if ($totaldata['date'] != '0000-00-00') {
                                      echo $idd;
                                    } ?></td>
        <td style="font-size:13px;"><?php if ($totaldata['date'] != '0000-00-00') {
                                      echo date('d-m-Y', strtotime($totaldata['date']));
                                    } ?></td>
        <td style="font-size:13px;"><?php if ($totaldata['totalfishcoldstorecharges'] != '0') {
                                      echo $totaldata['totalfishcoldstorecharges'];
                                    } ?></td>
        <td style="font-size:13px;"><?php if ($totaldata['totalfishlabourcharges'] != '0') {
                                      echo $totaldata['totalfishlabourcharges'];
                                    } ?></td>
        <td style="font-size:13px;"><?php if ($totaldata['totalrepackingcharges'] != '0') {
                                      echo $totaldata['totalrepackingcharges'];
                                    } ?></td>
        <td style="font-size:13px;"><?php if ($totaldata['totaldryfishcoldstorecharges'] != '0') {
                                      echo $totaldata['totaldryfishcoldstorecharges'];
                                    } ?></td>
        <td style="font-size:13px;"><?php if ($totaldata['totaldryfishlabourcharges'] != '0') {
                                      echo $totaldata['totaldryfishlabourcharges'];
                                    } ?></td>
        <td style="font-size:13px;"><?php if ($totaldata['plugoncharges'] != '0') {
                                      echo $totaldata['plugoncharges'];
                                    } ?></td>
        <td style="font-size:13px;"><?php if ($totaldata['total_charges'] != '0') {
                                      echo $totaldata['total_charges'];
                                    } ?></td>
        <td style="font-size:13px;"><?php if ($totaldata['payment_date'] != "0000-00-00") {
                                      echo date('d-m-Y', strtotime($totaldata['payment_date']));
                                    }; ?></td>
        <td style="font-size:13px;"><?php if ($totaldata['payment_amount'] != "0") {
                                      echo $totaldata['payment_amount'];
                                    }; ?></td>
...
?>
  <table class="table table-hover table-striped table-bordered mt-3" border="1">
    ...
    foreach ($receivabledatas as $receivabledata) :
      $ac_name = selectTestingExportAccount($receivabledata['ac_code']);
    ?>
      <tr>
        <td><?php if ($receivabledata['date'] != '0000-00-00') {
              echo date('d-m-Y', strtotime($receivabledata['date']));
            }; ?></td>
        <!-- <td><?php //if(!empty($receivabledata['invoice_amount'])){ if(!empty($ac_name['name'])){ echo $ac_name['name'];} }
                  ?></td> -->
...
if ($_GET['table_name'] == 'payable') {
  ...
  header("Content-Type: application/xls");
  header("Content-Disposition: attachment; filename=payableexport" . date('d-m-Y', strtotime($searchdate)) . ".xls");
  header("Pragma: no-cache");
  header("Expires: 0");
?>
  <?php
  ...
  ?>
    ...
    <table class="mt-3 table table-bordered table-striped rounded">
      ...
      foreach ($payablesuppliers as $payablesupplier) :
        ...
        $supplier_id = $payablesupplier['supplier_id'];
        $supplierdata = selectTestingExportContact($supplier_id);

      ?>
        <tr style="<?php if ($balance == 0 && $addamount == 0 && $paidamount == 0) {
                      echo 'display:none;';
                    } ?>">
          <td><?= $id; ?></td>
          <td><?= $supplierdata['name']; ?></td>
          <td><?= $balance; ?></td>
          <td><?php if ($addamount != 0) {
                echo $addamount;
              }; ?></td>
          <td><?php if ($paidamount != 0) {
                echo $paidamount;
              }; ?></td>
    ...
    <table>
      <tr>
        <td class="float-start" style="font-weight: bold;">
          ...
          $acnamedata = selectTestingExportContact($customer_id);
          $customerdata = $query->select('customers', $customer_id, 'customer_id');
          echo $acnamedata['name'];
          ?><br><?php
  ...
  <table border="1">
    ...
    ?>
      ...
      <tr style="font-weight: bold !important; background-color:#D3D3D3;">
        ...
        <td><?php if (!empty($totalnetweightdata['totalnetweight'])) {
              echo $totalnetweightdata['totalnetweight'];
            }; ?></td>
        <td></td>
        <td></td>
      </tr>
  ...
  <table border="1">
    ...
    ?>
      ...
      <tr class="text-center">
        ...
        <td style="font-weight: bold;"></td>
        <td style="font-weight: bold;"></td>
        <td style="font-weight: bold;"><?php if ($hhktotalmc != 0) {
                                          echo $hhktotalmc;
                                        } else {
                                          echo "-";
                                        }; ?></td>
        <td style="font-weight: bold;"><?php if ($gfctotalmc != 0) {
                                          echo $gfctotalmc;
                                        } else {
                                          echo "-";
                                        }; ?></td>
        <td style="font-weight: bold;"><?php if ($gfctotalmc != 0 || $hhktotalmc != 0) {
                                          echo $hhktotalmc + $gfctotalmc;
                                        } else {
                                          echo "-";
                                        }; ?></td>
      </tr>
...
?>
  <table class="table table-hover table-bordered table-striped" border="1">
    <tr>
      ...
      <th>loading <?php if ($headerdata['loading_no'] != 0) {
    ...
    ?>
      <tr>
        ...
        <td style="text-align:right;"><?php if ($tclmcdata['opening_mc'] != 0) {
                                        echo $tclmcdata['opening_mc'];
                                      } else {
                                        echo "-";
                                      } ?></td>
        <td style="text-align:right;"><?php echo $tclmcdata['form10mc']; ?></td>
        <td style="text-align:right;"><?php if ($tclmcdata['transfer_mc'] != 0) {
                                        echo $tclmcdata['transfer_mc'];
                                      } else {
                                        echo "-";
                                      } ?></td>
        <td style="text-align:right;"><?php if ($tclmcdata['loading_mc'] != 0) {
                                        echo $tclmcdata['loading_mc'];
                                      } else {
                                        echo "-";
                                      } ?></td>
        <td style="text-align:right;"><?php if ($tclmcdata['grandtotal_mc'] != 0) {
                                        echo $tclmcdata['grandtotal_mc'];
                                      } else {
                                        echo "-";
                                      } ?></td>
      </tr>
    ...
    <tr>
      ...
      <td style="font-weight:bold; text-align:right;"><?php if ($openingmctotaldatas['openingmc'] != 0) {
                                                        echo $openingmctotaldatas['openingmc'];
                                                      } else {
                                                        echo "-";
                                                      } ?></td>
      <td style="font-weight:bold; text-align:right;"><?php if ($form10mctotaldatas['totalform10mc'] != 0) {
                                                        echo $form10mctotaldatas['totalform10mc'];
                                                      } else {
                                                        echo "-";
                                                      } ?></td>
      <td style="font-weight:bold; text-align:right;"><?php if ($transfermctotaldatas['transfermc'] != 0) {
                                                        echo $transfermctotaldatas['transfermc'];
                                                      } else {
                                                        echo "-";
                                                      } ?></td>
      <td style="font-weight:bold; text-align:right;"><?php if ($loadingmctotaldatas['loadingmc'] != 0) {
                                                        echo $loadingmctotaldatas['loadingmc'];
                                                      } else {
                                                        echo "-";
                                                      } ?></td>
      <td style="font-weight:bold; text-align:right;"><?php if ($grandtotalmctotaldatas['grandtotalmc'] != 0) {
                                                        echo $grandtotalmctotaldatas['grandtotalmc'];
                                                      } else {
                                                        echo "-";
                                                      } ?></td>
    </tr>
...
if ($_GET['table_name'] == 'actualtruckinvoice') {
  ...
  <div class="actualinvoicetable">
    <table class="table table-striped table-hover table-bordered" border="1">
      ...
      ?>
          <tr data-bs-toggle="modal" data-bs-target="#usdadd<?php echo $packingstockinfodata['id']; ?>">
            ...
            <td><?php if (empty($checklastavaliable)) {
                  echo $packingstockinfodata['pcsperbox'];
                } ?></td>
            <td><?php echo $packingstockinfodata['kgperbox']; ?></td>
            <td><?php echo $packingstockinfodata['mc']; ?></td>
            <td><?php echo $packingstockinfodata['netweight']; ?></td>
            <td><?php if ($packingstockinfodata['usd'] != 0) {
                  echo $packingstockinfodata['usd'];
                }; ?></td>
            <td><?php if ($packingstockinfodata['total_usd'] != 0) {
                  echo $packingstockinfodata['total_usd'];
                }; ?></td>
          </tr>
          <?php
        ...
        <tr style="font-weight:bold; background-color: lightgray;">
          ...
          <td></td>
          <td><?php echo $totalmcdata['totalmc']; ?></td>
          <td><?php if (!empty($netweightdata['netweight'])) {
                echo $netweightdata['netweight'];
              }; ?></td>
          <td></td>
          <td><?php if ($totalusddata['total_usd'] != 0) {
                echo $totalusddata['total_usd'];
              }; ?></td>
        </tr>
      <?php
        $no1++;
    ...
    <h5 style="text-transform:uppercase;">Total Foam Box - <?php if (!empty($foamboxdata['total_foambox_no'])) {
                                                              echo $foamboxdata['total_foambox_no'] . " Box";
                                                            }; ?></h5>
    <h5 style="text-transform:uppercase;">Total Net Weight - <?php if (!empty($netweightdata['total_netweight'])) {
                                                                echo $netweightdata['total_netweight'] . " KGS";
                                                              }; ?></h5>
    <h5 style="text-transform:uppercase;">Total Value USD - <?php if (!empty($totalusddata['total_usd'])) {
                                                              echo $totalusddata['total_usd'] . " USD";
                                                            }; ?></h5>
    <br><br>
  </div>
<?php
  ...
  <div class="foamboxtable">
    <table class="table table-striped table-hover table-bordered" border="1">
      ...
      ?>
        ...
        ?>
        <tr style="font-weight:bold; background-color: lightgray; <?php if (empty($totalkgperboxdata['total_kgperbox'])) {
                                                                    echo 'display:none;';
                                                                  } ?>">
          <td></td>
          <td>Sub Total</td>
    ...
    <h5 style="text-transform:uppercase;">Total Net Weight - <?php if (!empty($netweightdata['netweight'])) {
                                                                echo $netweightdata['netweight'] . " KGS";
                                                              }; ?></h5>
  </div>
<?php
}
    ...
    <table class="table table-striped table-hover table-bordered" border="1">
      ...
      ?>
          <tr data-bs-toggle="modal" data-bs-target="#updatekgperbox<?php echo $packingstockinfodata['id']; ?>">
            ...
            <td><?php echo $packingstockinfodata['pcsperbox']; ?></td>
            <td><?php if ($packingstockinfodata['kgperbox'] != 0) {
                  echo $packingstockinfodata['kgperbox'];
                } else {
                  echo "-";
                }; ?></td>
            <td><?php echo $packingstockinfodata['mc']; ?></td>
            <td><?php if ($packingstockinfodata['netweight'] != 0) {
                  echo $packingstockinfodata['netweight'];
                } else {
                  echo "-";
                }; ?></td>
          </tr>
...
?>
  ...
  <div class="packingstocktable">
    <table class="table table-striped table-hover table-bordered" border="1">
      ...
      ?>
        ...
        <tr style="font-weight:bold;background-color: lightgray;">
          ...
          <td><?php if (!empty($totalgrssweightdata['totalgrossweight'])) {
                echo $totalgrssweightdata['totalgrossweight'];
              }; ?></td>
          <td></td>
        </tr>
      <?php
      ...
      <tr style="background-color: lightgray;">
        ...
        <td style="font-weight:bold !important;"><?php if (!empty($netweightdata['netweight'])) {
                                                    echo $netweightdata['netweight'];
                                                  }; ?></td>
        <td style="font-weight:bold !important;"><?php if (!empty($totalgrssweightdata['totalgrossweight'])) {
                                                    echo $totalgrssweightdata['totalgrossweight'];
                                                  }; ?></td>
        <td></td>
      </tr>
    ...
    <h5 style="text-transform:uppercase;">Total Gross Weight - <?php if (!empty($totalgrssweightdata['totalgrossweight'])) {
                                                                  echo $totalgrssweightdata['totalgrossweight'] . " KGS";
                                                                }; ?></h5>
  </div>
<?php
}
    ...
    <table class="table table-striped table-hover table-bordered text-center" border>
      ...
      ?>
        <tr data-bs-toggle='modal' data-bs-target="#updatetotalcosting<?php echo $data['id']; ?>">
          ...
          <td><?php if ($ttlkgdata['total_kg'] != 0) {
                echo $ttlkgdata['total_kg'];
              } else {
                echo "-";
              } ?></td>
          <td><?php if ($data['priceperviss'] != 0) {
                echo $data['priceperviss'];
              } else {
                echo "-";
              } ?></td>
          <td><?php if ($data['priceperkg'] != 0) {
                echo $data['priceperkg'];
              } else {
                echo "-";
              } ?></td>
          <td><?php if ($data['percentage'] != 0) {
                echo $data['percentage'];
              } else {
                echo "-";
              } ?></td>
          <td><?php if ($data['packing_charges'] != 0) {
                echo $data['packing_charges'];
              } else {
                echo "-";
              } ?></td>
          <td><?php if ($data['ygntomtorst_charges'] != 0) {
                echo $data['ygntomtorst_charges'];
              } else {
                echo "-";
              } ?></td>
          <td><?php if ($data['mtorsttotechnck_charges'] != 0) {
                echo $data['mtorsttotechnck_charges'];
              } else {
                echo "-";
              } ?></td>
          <td><?php if ($data['labour_charges'] != 0) {
                echo $data['labour_charges'];
              } else {
                echo "-";
              } ?></td>
          <td><?php if ($data['packingandtransport'] != 0) {
                echo $data['packingandtransport'];
              } else {
                echo "-";
              } ?></td>
          <td><?php if ($data['grand_total'] != 0) {
                echo $data['grand_total'];
              } else {
                echo '-';
              } ?></td>
          <td><?php if ($data['rate'] != 0) {
                echo $data['rate'];
              } else {
                echo '-';
              } ?></td>
          <td><?php if (round($data['costing_usd'], 2) != 0) {
                echo round($data['costing_usd'], 2);
              } else {
                echo '-';
              } ?></td>
          <td><?php if ($data['selling_rate'] != 0) {
                echo $data['selling_rate'];
              } else {
                echo '-';
              } ?></td>
          <td><?php if ($data['profitperkg'] != 0) {
                echo round($data['profitperkg'], 2);
              } else {
                echo '-';
              } ?></td>
        </tr>
...
?>
  <table>
    <tr>
      ...
      <td></td>
      <td colspan="2">
        <h3>Truck Packing Material Charges</h3>
      </td>
...
?>
  ...
  <table class="table table-hover table-striped table-bordered" border="1">
    ...
    foreach ($form7datas as $form7data) {
      ...
      $supplier_name = selectTestingExportParty($supplier_id);
    ...
    ?>
      <tr>
        ...
        <td>
          <?php
           if (empty($lastcommondity)) {
                echo date('d-m-Y', strtotime($searchdate));
            }
          ?>
        </td>
        <td><?php if(!empty($form10data['pcsform10'])){ echo $form10data['pcsform10']; } ?></td>
        <td><?php if(!empty($form10data['mc'])){ echo $form10data['mc']; } ?></td>
        <td><?php if(!empty($form10data['kg'])){ echo $form10data['kg']; } ?></td>
        <td><?php if(!empty($form10data['pcs'])){ echo $form10data['pcs']; } ?></td>
        <td><?php if(!empty($form10data['looseinkg'])){ echo $form10data['looseinkg']; } ?></td>
        <td><?php if(!empty($form10data['looseinpcs'])){ echo $form10data['looseinpcs']; } ?></td>
        <td><?php if(!empty($form10data['looseoutkg'])){ echo $form10data['looseoutkg']; } ?></td>
        <td><?php if(!empty($form10data['looseoutpcs'])){ echo $form10data['looseoutpcs']; } ?></td>
        <td><?php if(!empty($form10data['total_kg'])){ echo round($form10data['total_kg'], 2); } ?></td>
        <td></td>
      </tr>
    <?php
    }
    ...
    $form10pcsstmt = $pdo->prepare("SELECT SUM(pcsform10) AS total_form10_pcs FROM form10stock WHERE item_id='$commondity_id' AND country='$country' AND date='$searchdate'");
    $form10pcsstmt->execute();
    $form10pcsdata = $form10pcsstmt->fetch(PDO::FETCH_ASSOC);

    $mcstmt = $pdo->prepare("SELECT SUM(mc) AS total_mc FROM form10stock WHERE item_id='$commondity_id' AND country='$country' AND date='$searchdate'");
    $mcstmt->execute();
    $mcdata = $mcstmt->fetch(PDO::FETCH_ASSOC);

    $kgstmt = $pdo->prepare("SELECT SUM(kg) AS kg FROM form10stock WHERE item_id='$commondity_id' AND country='$country' AND date='$searchdate'");
    $kgstmt->execute();
    $kgdata = $kgstmt->fetch(PDO::FETCH_ASSOC);

    $form10pcs = $pdo->prepare("SELECT SUM(pcs) AS pcs FROM form10stock WHERE item_id='$commondity_id' AND country='$country' AND date='$searchdate'");
    $form10pcs->execute();
    $form10dbpcsdata = $form10pcs->fetch(PDO::FETCH_ASSOC);

    $form10looseinkg = $pdo->prepare("SELECT SUM(looseinkg) AS kg FROM form10stock WHERE item_id='$commondity_id' AND country='$country' AND date='$searchdate'");
    $form10looseinkg->execute();
    $form10looseinkgdata = $form10looseinkg->fetch(PDO::FETCH_ASSOC);

    $form10looseinpcs = $pdo->prepare("SELECT SUM(looseinpcs) AS pcs FROM form10stock WHERE item_id='$commondity_id' AND country='$country' AND date='$searchdate'");
...
?>
  ...
  <table class="mt-1 table table-bordered table-striped rounded" border="1">
    ...
    ?>
      <tr>
        <td><?php if ($payabledata['date'] != '0000-00-00') {
              echo date('d-m-Y', strtotime($payabledata['date']));
            }; ?></td>
        <td><?php if ($payabledata['paid_voucher'] == '') {
              echo $payabledata['purchase_voucher_no'];
            } ?></td>
        <td><?php if ($totalpurchaseamount['total_purchase_amount'] != 0) {
              echo $totalpurchaseamount['total_purchase_amount'];
            }; ?></td>
        <td><?php if ($payabledata['paid_date'] != "0000-00-00") {
              echo date('d-m-Y', strtotime($payabledata['paid_date']));
            }; ?></td>
        <td><?php echo $payabledata['paid_voucher']; ?></td>
        <td><?php echo $payabledata['remark']; ?></td>
        <td><?php if (!empty($payabledata['paid_amount'])) {
              echo $payabledata['paid_amount'];
            }; ?></td>
        <?php
        if ($payabledata['paid_date'] != "0000-00-00") {
        ?>
          <td><?php if (!empty($thebalanceamount) || $thebalanceamount == '0') {
