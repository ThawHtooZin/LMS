...
<body>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-warning btn-sm text-light" data-bs-toggle="modal"
                                        data-bs-target="#updatemodal<?php echo $supplierdata['supplier_id']; ?>">Edit</button>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="supplier.php" method="post" autocomplete="off">
                    <div class="modal-body">
                        <label>Supplier ID</label>
                        <input type="text" name="supplier_id" id="supplier_id" class="form-control" placeholder="Supplier ID" value="4000/" oninput="validateInput('supplier', 'supplier_id', this.value, 'id_error')" required>
    ...
    <script>
        function validateInput(table, column, value, errorId) {
            ...
            fetch(`supplier.php?action=check_duplicate&table=${table}&column=${column}&value=${encodeURIComponent(value)}`)
