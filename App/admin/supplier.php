...
<html lang="en" dir="ltr">
            ...
            <table class="mt-1 table table-bordered table-striped rounded">
              ...
              <tr>
                ...
                <td>
                  ...
                  <button type="submit" class="btn btn-warning btn-sm text-light" data-bs-toggle="modal" data-bs-target="#updatemodal<?php echo $supplierdata['supplier_id']; ?>">
  ...
  <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
                ...
                <form action="supplier.php" method="post" style="display: inline !important;">
                  <input type="hidden" name="deleteid" value="<?php echo $supplierdata['supplier_id']; ?>">
              ...
              <!-- Data Update Modal -->
              <div class="modal fade" id="updatemodal<?php echo $supplierdata['supplier_id']; ?>" tabindex="-1" role="dialog" >
                    ...
                    <form action="" method="post" autocomplete="off">
                      <div class="modal-body">
                        ...
                        <label>Supplier Phone</label>
                          <input type="number" name="supplier_phone" class="form-control" placeholder="Supplier Phone" value="<?php echo $supplierdata['supplier_phone']; ?>">
                        <label>Supplier Address</label>
                          <input type="text" name="supplier_address" class="form-control" placeholder="Supplier Address" value="<?php echo $supplierdata['supplier_address']; ?>">
                      </div>
