    ...
    <div class="contentcol" id="content">
        ...
        <form action="" method="post">
          <div class="card">
            <div class="card-header bg-info">
              ...
              <a href="<?php if ($_GET['file'] == 'payable') {
                          echo 'acpayable.php';
                        }
                        if ($_GET['file'] == 'receivable') {
                          echo 'accountreceivable.php';
                        }
                        if ($_GET['file'] == 'cashbook') {
                          echo 'cashbook.php';
                        }
                        if ($_GET['file'] == 'general_ledger') {
                          echo 'general_ledger.php';
                        } ?>" class="btn btn-danger btn-sm float-end">Exit</a>
        ...
        <div class="card-body">
          ...
          <table class="table table-hover table-striped">
            ...
            foreach ($datas as $data) {
              ...
              $currencystmt = $pdo->prepare("SELECT * FROM currency WHERE voucher_no=:voucher_no AND debitorcredit='$dorc' AND transactionid='$transaction_id'");
              ...
              <div id='collapseofupdate'>
                <div id="updatecollapse<?php echo $data['id']; ?>" class="collapse mb-2" data-bs-parent="#accordion">
                  <form action="" method="post">
                    ...
                    <input type="hidden" name="cash_id" value="<?php if (!empty($_GET['id'])) {
                                                                  echo $_GET['id'];
                                                                } ?>">
                    <input type="hidden" name="payableid" value="<?php if (!empty($_GET['payableid'])) {
                                                                    echo $_GET['payableid'];
                                                                  } ?>">
      ...
      <tr style="font-weight:bold;">
        ...
        <td style="<?php if ($totaldebitdata['total'] != $totalcreditdata['total']) {
                      echo "color:red;";
                    } ?>"><?php echo $totaldebitdata['total']; ?></td>
        <td style="<?php if ($totaldebitdata['total'] != $totalcreditdata['total']) {
                      echo "color:red;";
                    } ?>"><?php echo $totalcreditdata['total']; ?></td>
      </tr>
      </table>
      </div>
      <!-- TABLEEEEEEEEEEEEEEEEEEEE -->
