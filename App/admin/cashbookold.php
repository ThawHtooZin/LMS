        ...
        <table class="table table-bordered table-striped rounded">
          ...
          ?>
            <tr>
              ...
              <td><?php if (!empty($crossacnamedata['ac_name'])) {
                    echo $crossacnamedata['ac_name'];
                  }; ?></td>
              <td><?php echo $cashdata['particular']; ?></td>
              <td><?php if ($cashdata['debit'] == 0) {
                    echo "";
                  } else {
                    echo round($debit, 2);
                  }; ?></td>
              <td><?php if ($cashdata['credit'] == 0) {
                    echo "";
                  } else {
                    echo round($credit, 2);
                  }; ?></td>
              ...
              <td>
                ...
                ?>
                  <a href="edittransaction.php?voucher_no=<?= $cashdata['voucher_no']; ?>&file=cashbook&transactionid=<?php if (!empty($cashdata['transactionid'])) {
                                                                                                                        echo $cashdata['transactionid'];
                                                                                                                      }; ?>&id=<?= $cashdata['id']; ?>&ac_code=<?php if (!empty($cashdata['ac_name'])) {
                                                                                                                                                                  echo $cashdata['ac_name'];
                                                                                                                                                                } ?>&crossac_code=<?php if (!empty($crossac_nameid)) {
                                                                                                                                                                                                                                                                echo $crossac_nameid;
                                                                                                                                                                                                                                                              } ?>">
                    ...
                    <form method="POST" action="">
                      ...
                      <div class="form-group">
                        ...
                        <select name="updatebalanceaccode" class="form-control inpv2">
                          ...
                          foreach ($acdatas as $acdata) {
                          ?>
                            <option value="<?= $acdata['code_no']; ?>" <?php if ($acdata['ac_name'] == $cashdata['ac_name']) {
                                                                          echo "selected";
