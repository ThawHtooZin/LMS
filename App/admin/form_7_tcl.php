          ...
          <table class="table table-hover table-striped table-bordered">
            ...
            ?>
                  <tr data-bs-toggle="modal" data-bs-target="#updatemodal<?php echo $form7data['id']; ?>">
                    ...
                    <td><?php if (!empty($form7data['kg'])) {
                          echo round($form7data['kg'], 2);
                        }; ?></td>
                    <td><?php echo $form7data['pcspervr']; ?></td>
                    <td><?php if (!empty($form7data['pcsperf7'])) {
              ...
              for ($i = 0; $i < $commonditycountdatas; $i++) {
                ...
                <td></td>
                <td></td>
                <td><?php //echo round($totalvissdata['total_viss'], 3); 
                    ?></td>
                <td><?php //echo round($totalkgdata['total_kg'], 2); 
                    ?></td>
                <td><?php //if(!empty($totalpcsdata['total_pcs'])){ echo $totalpcsdata['total_pcs']; }; 
                    ?></td>
                <td><?php //if(!empty($totalpcsf7data['total_pcsf7'])){ echo $totalpcsf7data['total_pcsf7']; }; 
                    ?></td>
              </tr> -->
                <?php
              }
              ...
              for ($i = 0; $i < $commonditycountdatas; $i++) {
                ...
                ?>
                  <tr>
                    ...
                    <td data-bs-target="#addsizemodal<?php echo $form7data['id']; ?>" data-bs-toggle="modal" style="cursor:pointer;"><?php echo $form7data['size']; ?></td>
                    ...
                    <td><?php echo $form7data['pcspervr']; ?></td>
                    <td data-bs-toggle="modal" data-bs-target="#updatemodal<?php echo $form7data['id']; ?>" style="cursor:pointer;"><?php if (!empty($form7data['pcsperf7'])) {
                                                                                                                                      echo $form7data['pcsperf7'];
                                                                                                                                    }; ?></td>
                    <!-- <td>
                       <form action="form_7_tcl.php" method="post">
