            ...
            <table class="table table-hover table-bordered table-striped" id="<?php //echo $countrydata['country']; 
              ...
              ?>
                <tr>
                  ...
                  <td><?php if ($tclmcdata['opening_mc'] != 0) {
                  ...
                  <td><?php if ($tclmcdata['grandtotal_mc'] != 0) {
              ...
              <tr>
                ...
                <td style="font-weight:bold;"><?php if ($openingmctotaldatas['openingmc'] != 0) {
                                                echo $openingmctotaldatas['openingmc'];
                                              } else {
                                                echo "-";
                                              } ?></td>
                <td style="font-weight:bold;"><?php if ($form10mctotaldatas['totalform10mc'] != 0) {
                ...
                <td style="font-weight:bold;"><?php if ($grandtotalmctotaldatas['grandtotalmc'] != 0) {
