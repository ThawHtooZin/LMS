      ...
      <div class="container-fluid d-flex justify-content-center align-items-center" style="min-height: 75vh;">
        <div class="row w-100 justify-content-evenly">
          ...
          <div class="col-12 col-md-5 col-lg-4">
            <a href="form_7_frozen.php" class="nav-card">
              ...
              <div class="nav-card-title">Form-7 (Frozen)</div>
            </a>
          </div>

          <div class="col-12 col-md-5 col-lg-4">
            <a href="form_7_tcl.php" class="nav-card">
              ...
              <div class="nav-card-title">Form-7 (TCL)</div>
            </a>
          </div>
