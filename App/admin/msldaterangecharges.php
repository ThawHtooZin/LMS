...
<body>
            ...
            <table class="table table-striped table-bordered table-hover">
              ...
              ?>
                  <tr>
                    ...
                    <td><?php if ($data['outdate'] != '0000-00-00') {
                          echo date("d-m-Y", strtotime($data['outdate']));
                        } else {
                          echo "Loose";
                        }; ?></td>
                    <td><?php echo htmlspecialchars(($commonditydata['name'] ?? 'Unknown') . " (" . $data['fish_type'] . ")"); ?></td>
            ...
            <table class="table table-striped table-bordered table-hover">
              ...
              ?>
                  <tr>
                    ...
                    <td><?php echo htmlspecialchars(($commonditydata['name'] ?? 'Unknown') . " (" . $labourdata['fish_type'] . ")"); ?></td>
            ...
            <table class="table table-striped table-bordered table-hover">
              ...
              ?>
                  <tr>
                    ...
                    <td><?php echo htmlspecialchars(($commonditydata['name'] ?? 'Unknown') . " (" . $processingdata['fish_type'] . ")"); ?></td>
              ...
              ?>
                <tr data-bs-toggle="modal" data-bs-target="#updatetotalcharges<?php echo $total_charges_data['id']; ?>">
                  ...
                  <td><?php if (!empty($commonditydata['name'])) {
                        echo htmlspecialchars($commonditydata['name']) . " (" . $total_charges_data['fish_type'] . ")";
                      }; ?></td>
                  <td><?php if ($total_charges_data['total_coldstore_charges'] != "0") {
                        echo $total_charges_data['total_coldstore_charges'];
                      }; ?></td>
                  <td><?php if ($total_charges_data['total_freezing_charges'] != "0") {
                        echo $total_charges_data['total_freezing_charges'];
                      }; ?></td>
                  <td><?php if ($total_charges_data['total_export_charges'] != "0") {
                        echo $total_charges_data['total_export_charges'];
                      }; ?></td>
                  <td><?php if ($total_charges_data['repacking_charges'] != "0") {
                        echo $total_charges_data['repacking_charges'];
                      }; ?></td>
                  <td><?php if ($total_charges_data['ice_charges'] != "0") {
                  ...
                  <td><?php if ($total_charges_data['remark'] != "0") {
                        ...
                        <div class="modal-body">
                          ...
                          <div class="row">
                            <div class="col">
                              ...
                              <input type="number" name="repacking_charges" class="form-control inpv2 mb-2" value="<?php if (!empty($updatedata['repacking_charges'])) {
            ...
            <table class="table table-striped table-bordered table-hover">
              ...
              ?>
                <tr>
                  ...
                  <td><?php if ($repackingdata['sheet'] != '0') {
                        echo $repackingdata['sheet'];
                      }; ?></td>
                  <td><?php if ($repackingdata['plastic'] != '0') {
                        echo $repackingdata['plastic'];
                      }; ?></td>
            ...
            <table class="table table-hover table-striped table-bordered">
              ...
              ?>
                  <tr>
                    ...
                    <td><?php echo htmlspecialchars(($commonditydata['name'] ?? 'Unknown') . " (" . $hhkstockdata['fish_type'] . ")"); ?></td>
  ...
  <script type="text/javascript">
    // ... JavaScript tab handlers remain untouched ...
    <?php
