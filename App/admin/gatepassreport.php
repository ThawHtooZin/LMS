        ...
        <div class="contentcol" id="content">
            ...
            <div class="card">
                <div class="card-header bg-primary text-light" style="padding:-10px;">
                    ...
                    ?>
                    <h1 class="merriweather-light text-center">*Packing Material (Gate Pass) Report*</h1>
                            ...
                            <tr>
                                ...
                                ?>
                                    ...
                                    ?>
                                        ...
                                        <td style="color: red; font-weight: bolder;"><?php if ($totalout['totalout'] == '') {
                                                                                            echo '-';
                                                                                        } else {
                                    ...
                                    ?>
                                        ...
                                        <td style="color: blue; font-weight: bolder;"><?php if ($totalamount == '') {
                                                                                            echo '-';
                                                                                        } else {
                                                                                            echo $totalamount;
                                                                                        }; ?></td>
