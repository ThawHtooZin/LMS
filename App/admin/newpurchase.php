...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['action_type'])) {
    ...
    // Remap action names for the query controller logic
    ...
    $query->savePurchase(null, $contact_id, $date, $due_date, $voucher_no, $currency, $status, $subtotal, $subtotal, $lines, $ctrl_action);
}
