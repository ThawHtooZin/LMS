...
INSERT INTO `bankdetail` VALUES (4,'1503','','','','','UAB Bank','','',''),(5,'1502','','','','','KBZ Bank','','','');
...
INSERT INTO `hhkmcstock` VALUES (1,'can','balance','2026-09-17','2','2up','21',67,67,'','',0,'','',0,'','G'),(2,'can','balance','2026-09-17','4','3up','22',20,20,'','',0,'','',0,'','G'),(3,'can','balance','2026-09-17','2','2up','22',10,10,'','',0,'','',0,'','G'),(4,'can','balance','2026-09-17','4','3up','23',16,16,'','',0,'','',0,'','G'),(5,'can','fromform10','2026-09-17','4','3up','22',5,25,'','',0,'','',0,'','G'),(6,'can','fromform10','2026-09-17','4','3up','23',3,19,'','',0,'','',0,'','G'),(7,'can','fromform10','2026-09-17','4','3up','20',2,2,'','',0,'','',0,'','G'),(8,'can','repackingout','2026-09-17','4','3up','22',2,23,'','',0,'','',0,'','G'),(9,'can','hhktogfc','2026-09-17','4','3up','22',10,13,'','',0,'','',0,'','G');
...
INSERT INTO `material_store_house` VALUES (4,'2026-09-22','12:11:08','V-001','','126',61,250,NULL,NULL,''),(5,'2026-09-22','12:15:14','V001','','126',61,NULL,50,5,''),(6,'2026-09-22','12:15:26','V-002','','126',61,NULL,60,6,''),(7,'2026-09-22','12:32:04','V00003','Return 10','',61,10,NULL,NULL,'return');
...
INSERT INTO `packingliststock` VALUES (1,'2026-09-21','144','United Stat','112222','12411','Jarvis','ToooNY','1231',3);
...
INSERT INTO `purchase_lines` VALUES (4,1,2,5000,'','2up',78.00,0,14500.00,1131000.00),(5,1,2,5000,'','3up',80.00,0,15000.00,1200000.00),(6,2,4,5000,'','1.5up',50.00,0,20000.00,1000000.00),(7,3,25,5000,'','5up',100.00,0,21000.00,2100000.00),(9,5,61,5001,'CartonBox','',0.00,250,1500.00,375000.00);
...
CREATE TABLE `stock_output_group` (
  ...
  `in_quantity` decimal(15,2) DEFAULT NULL,
  `out_quantity` decimal(15,2) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `stock_output_group` VALUES (5,'2026-09-22','12:15:14','HHK',NULL,'V001',NULL,NULL,'61',50.00,NULL),(6,'2026-09-22','12:15:26','GFC',NULL,'V-002',NULL,NULL,'61',60.00,NULL),(7,'2026-09-22','12:31:19','HHK','use','V00001','USE USE USE',NULL,'61',NULL,10.00),(8,'2026-09-22','12:31:39','HHK','transfer','V00002','Transfer Transfer',NULL,'61',NULL,10.00),(9,'2026-09-22','12:31:39','GFC','transfer','V00002','Transfer Transfer',NULL,'61',10.00,NULL),(10,'2026-09-22','12:32:04','HHK','return','V00003','Return 10',NULL,'61',NULL,10.00),(11,'2026-09-22','12:32:31','HHK','damaged','V00004','Damaged',NULL,'61',NULL,10.00);
...
--
-- Table structure for table `tclmc_transactions`
--

DROP TABLE IF EXISTS `tclmc_transactions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tclmc_transactions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `tclmc_id` int(11) NOT NULL,
  `transaction_date` date NOT NULL,
  `type` varchar(50) NOT NULL COMMENT 'transfer or export',
  `destination` varchar(100) NOT NULL COMMENT 'GFC, HHK, or Loading No',
  `quantity` int(11) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`),
  KEY `fk_tclmc_id` (`tclmc_id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tclmc_transactions`
--

LOCK TABLES `tclmc_transactions` WRITE;
/*!40000 ALTER TABLE `tclmc_transactions` DISABLE KEYS */;
INSERT INTO `tclmc_transactions` VALUES (9,5,'2026-09-22','export','10',25),(10,5,'2026-09-22','transfer','HHK',25);
/*!40000 ALTER TABLE `tclmc_transactions` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `tclmcstock` VALUES (5,'2026-09-22','25','2up',200,220,0,100,50);
...
-- Dump completed on 2026-09-22 15:17:35
