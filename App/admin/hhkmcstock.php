      ...
      <div class="col-10">
        <div class="card mt-1">
          <div class="card-header bg-info">
            ...
            <button type="button" class="btn btn-danger float-end ms-2" data-bs-toggle="modal" data-bs-target="#transfer">Tranfer Mc</button>
    ...
    <div class="modal fade" id="transfer">
      <div class="modal-dialog" role="document">
        ...
        <form action="hhkmcstock.php" method="post">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
            <button type="submit" class="btn btn-success" name="transferbtn">Add</button>
          </div>
        </form>
        </div>
      </div>
