      ...
      <div class="col-10">
        <div class="card">
          ...
          <div class="card-header bg-info">
            ...
            <button type="submit" class="btn btn-danger float-end btn-sm me-2" id="foambox" name="foamboxbtn">Foam Box</button>
            ...
            <a href="truck_packing_stock.php" class="btn btn-secondary float-end me-2 btn-sm" id="back">Back</a>
          </div>
        </form>
          <div class="card-body">
            <?php
            ...
            $infodata = $infostmt->fetch(PDO::FETCH_ASSOC);
             ...
             <br>
              <?php
               ...
               if (!empty($emptyornot)) {
              ?>
              <div class="packingstocktable" id="packingstocktable">
              ...
              ?>
             <!-- =============================================================== -->
             <div class="foamboxtable" id="foamboxtable">
               <table class="table table-striped table-hover table-bordered">
                 <tr>
                   <th>No</th>
                   <th>Commondity</th>
                 ...
                 <tr>
                   ...
                   <td><?php echo $packingstockinfodata['mc']; ?></td>
                   <td><?php echo $packingstockinfodata['netweight']; ?></td>
                   <td data-bs-toggle="modal" data-bs-target="#addfoambox"><?php echo $packingstockinfodata['foambox_no']; ?></td>
                 </tr>
                 <?php
                 ?>
                 <?php
             ...
             <!-- =============================================================== -->
             <div class="modal fade" id="addfoambox">
               <div class="modal-dialog" role="document">
                 <div class="modal-content" style="width: 650px; !important; margin-top:70px !important;">
                   <div class="modal-header bg-info text-light">
